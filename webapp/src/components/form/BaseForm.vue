  ...
  <form class="justify-center flex flex-col gap-4">
    <div class="flex gap-2 sm:gap-4 flex-col sm:flex-row">
      <div class="grid gap-2 grow">
        <textarea id="plaintext" class="rounded-md shadow-sm focus:border-rose-300 dark:focus:border-rose-500 focus:ring focus:ring-rose-200 dark:focus:ring-rose-400 focus:ring-opacity-50 resize-none dark:bg-stone-700 dark:text-white dark:border-stone-400 dark:placeholder:text-stone-400" :placeholder="textplaceholder"></textarea>
        <div class="flex gap-2 items-center">
          <input type="checkbox" id="base64" name="base64" class="rounded border-gray-300 text-rose-600 shadow-sm focus:border-rose-300 dark:focus:border-rose-500 focus:ring focus:ring-offset-0 focus:ring-rose-200 dark:focus:ring-rose-400 focus:ring-opacity-50">
